...
def test_download_data_main_block():
    ...
    with (
        patch("ifunnel.financial_data_preprocessing.get_yahoo_data.yf.download") as mock_download,
        patch("ifunnel.financial_data_preprocessing.get_yahoo_data.pd.read_excel"),
        ...
        download_data("2023-01-01", "2023-01-03", ["AAPL"])
        mock_download.assert_called_once()
